...
namespace TriggerAndTakePhoto.Services.CameraService;
...
*/
public class ToupcamService : IDisposable
{
    [Flags]
    ...
    public enum eOPTION : uint
    {
        ...
        OPTION_FRONTEND_DEQUE_LENGTH = 0x31,       /* frontend frame buffer deque length, range: [2, 1024], default: 3 */
    ...
    */
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = cc)]
    private static extern int Toupcam_AwbOnce(SafeCamHandle h, IntPtr fnTTProc, IntPtr pTTCtx);
    [DllImport(dll, ExactSpelling = true, CallingConvention = cc)]
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = cc)]
    private static extern int Toupcam_AbbOnce(SafeCamHandle h, IntPtr fnBBProc, IntPtr pBBCtx);
    ...
    [DllImport(dll, ExactSpelling = true, CallingConvention = cc)]
    private static extern int Toupcam_Update([MarshalAs(ut)] string camId, [MarshalAs(ut)] string filePath, PROGRESS_CALLBACK fnProgressProc, IntPtr pProgressCtx);
    ...
    private static void DataCallbackV3(IntPtr pData, IntPtr pInfo, bool bSnap, IntPtr pCallbackCtx)
    {
        ...
        {
            ToupcamService pthis = obj as ToupcamService; 
            if (pthis != null)
    ...
    */
    private ToupcamService(SafeCamHandle h)
    {
        _handle = h;
    ...
    /* get the version of this dll/so, which is: 50.19728.20211022 */
    ...
    {
        return (Toupcam_put_Option(null, iOption, iValue) >= 0);
    }

    public static bool get_GlobalOption(eOPTION iOption, out int iValue)
    {
        return (Toupcam_get_Option(null, iOption, out iValue) >= 0);
    }
    ...
    */
    /*
        ...
        etc
    */
    public static ToupcamService OpenByIndex(uint index)
    {
    ...
    public bool StartPullModeWithWndMsg(IntPtr hWnd, uint nMsg)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_StartPullModeWithWndMsg(_handle, hWnd, nMsg));
    }
#endif
    ...
    public bool StartPullModeWithCallback(DelegateEventCallback edelegate)
    {
        ...
        if (edelegate != null)
        {
            ...
            return CheckHResult(Toupcam_StartPullModeWithCallback(_handle, _pEventCallback, _id));
        }
        else
        {
            return CheckHResult(Toupcam_StartPullModeWithCallback(_handle, null, IntPtr.Zero));
        }
    }
    ...
    public bool PullImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Toupcam_PullImage(_handle, pImageData, bits, out pnWidth, out pnHeight));
    }
    ...
    public bool PullImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Toupcam_PullImageV2(_handle, pImageData, bits, out pInfo));
    }
    ...
    public bool PullStillImage(IntPtr pImageData, int bits, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Toupcam_PullStillImage(_handle, pImageData, bits, out pnWidth, out pnHeight));
    }
    ...
    public bool PullStillImageV2(IntPtr pImageData, int bits, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Toupcam_PullStillImageV2(_handle, pImageData, bits, out pInfo));
    }
    ...
    */
    public bool PullImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Toupcam_PullImageWithRowPitch(_handle, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
    }
    ...
    public bool PullImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Toupcam_PullImageWithRowPitchV2(_handle, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool PullStillImageWithRowPitch(IntPtr pImageData, int bits, int rowPitch, out uint pnWidth, out uint pnHeight)
    {
        ...
        return CheckHResult(Toupcam_PullStillImageWithRowPitch(_handle, pImageData, bits, rowPitch, out pnWidth, out pnHeight));
    }
    ...
    public bool PullStillImageWithRowPitchV2(IntPtr pImageData, int bits, int rowPitch, out FrameInfoV2 pInfo)
    {
        ...
        return CheckHResult(Toupcam_PullStillImageWithRowPitchV2(_handle, pImageData, bits, rowPitch, out pInfo));
    }
    ...
    public bool StartPushModeV3(DelegateDataCallbackV3 ddelegate, DelegateEventCallback edelegate)
    {
        ...
        _pEventCallback = new EVENT_CALLBACK(EventCallback);        
        return CheckHResult(Toupcam_StartPushModeV3(_handle, _pDataCallbackV3, _id, _pEventCallback, _id));
    }
    ...
    public bool Stop()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_Stop(_handle));
    }
    ...
    public bool Pause(bool bPause)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_Pause(_handle, bPause ? 1 : 0));
    }
    ...
    public bool Snap(uint nResolutionIndex)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_Snap(_handle, nResolutionIndex));
    }
    ...
    public bool SnapN(uint nResolutionIndex, uint nNumber)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_SnapN(_handle, nResolutionIndex, nNumber));
    }
    ...
    */
    public bool Trigger(ushort nNumber)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_Trigger(_handle, nNumber));
    }
    ...
    public bool put_Size(int nWidth, int nHeight)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Size(_handle, nWidth, nHeight));
    }
    ...
    public bool get_Size(out int nWidth, out int nHeight)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Size(_handle, out nWidth, out nHeight));
    }
    ...
    */
    public bool put_eSize(uint nResolutionIndex)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_eSize(_handle, nResolutionIndex));
    }
    ...
    public bool get_eSize(out uint nResolutionIndex)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_eSize(_handle, out nResolutionIndex));
    }
    ...
    */
    public bool get_FinalSize(out int nWidth, out int nHeight)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_FinalSize(_handle, out nWidth, out nHeight));
    }
    ...
    public bool get_Resolution(uint nResolutionIndex, out int pWidth, out int pHeight)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Resolution(_handle, nResolutionIndex, out pWidth, out pHeight));
    }
    ...
    */
    public bool get_PixelSize(uint nResolutionIndex, out float x, out float y)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_PixelSize(_handle, nResolutionIndex, out x, out y));
    }
    ...
    */
    public bool get_ResolutionRatio(uint nResolutionIndex, out int pNumerator, out int pDenominator)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_ResolutionRatio(_handle, nResolutionIndex, out pNumerator, out pDenominator));
    }
    ...
    */
    public bool get_RawFormat(out uint nFourCC, out uint bitdepth)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_RawFormat(_handle, out nFourCC, out bitdepth));
    }
    ...
    */
    public bool put_RealTime(int val)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_RealTime(_handle, val));
    }
    ...
    public bool get_RealTime(out int val)
    {
        ...
        return CheckHResult(Toupcam_get_RealTime(_handle, out val));
    }
    ...
    public bool Flush()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_Flush(_handle));
    }
    ...
    public bool get_AutoExpoEnable(out bool bAutoExposure)
    {
        ...
        int iEnable = 0;
        if (!CheckHResult(Toupcam_get_AutoExpoEnable(_handle, out iEnable)))
            return false;
    ...
    public bool put_AutoExpoEnable(bool bAutoExposure)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_AutoExpoEnable(_handle, bAutoExposure ? 1 : 0));
    }
    ...
    public bool get_AutoExpoTarget(out ushort Target)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_AutoExpoTarget(_handle, out Target));
    }
    ...
    public bool put_AutoExpoTarget(ushort Target)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_AutoExpoTarget(_handle, Target));
    }
    ...
    public bool put_MaxAutoExpoTimeAGain(uint maxTime, ushort maxAGain)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_MaxAutoExpoTimeAGain(_handle, maxTime, maxAGain));
    }
    ...
    public bool get_MaxAutoExpoTimeAGain(out uint maxTime, out ushort maxAGain)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_MaxAutoExpoTimeAGain(_handle, out maxTime, out maxAGain));
    }
    ...
    public bool put_MinAutoExpoTimeAGain(uint minTime, ushort minAGain)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_MinAutoExpoTimeAGain(_handle, minTime, minAGain));
    }
    ...
    public bool get_MinAutoExpoTimeAGain(out uint minTime, out ushort minAGain)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_MinAutoExpoTimeAGain(_handle, out minTime, out minAGain));
    }
    ...
    public bool get_ExpoTime(out uint Time)/* in microseconds */
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_ExpoTime(_handle, out Time));
    }
    ...
    public bool put_ExpoTime(uint Time)/* in microseconds */
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_ExpoTime(_handle, Time));
    }
    ...
    public bool get_ExpTimeRange(out uint nMin, out uint nMax, out uint nDef)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_ExpTimeRange(_handle, out nMin, out nMax, out nDef));
    }
    ...
    public bool get_ExpoAGain(out ushort AGain)/* percent, such as 300 */
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_ExpoAGain(_handle, out AGain));
    }
    ...
    public bool put_ExpoAGain(ushort AGain)/* percent */
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_ExpoAGain(_handle, AGain));
    }
    ...
    public bool get_ExpoAGainRange(out ushort nMin, out ushort nMax, out ushort nDef)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_ExpoAGainRange(_handle, out nMin, out nMax, out nDef));
    }
    ...
    public bool put_LevelRange(ushort[] aLow, ushort[] aHigh)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_LevelRange(_handle, aLow, aHigh));
    }
    ...
    public bool get_LevelRange(ushort[] aLow, ushort[] aHigh)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_LevelRange(_handle, aLow, aHigh));
    }
    ...
    public bool put_LevelRangeV2(ushort mode, int roiX, int roiY, int roiWidth, int roiHeight, ushort[] aLow, ushort[] aHigh)
    {
        ...
        return CheckHResult(Toupcam_put_LevelRangeV2(_handle, mode, ref rc, aLow, aHigh));
    }
    ...
    public bool get_LevelRangeV2(out ushort mode, out int roiX, out int roiY, out int roiWidth, out int roiHeight, ushort[] aLow, ushort[] aHigh)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        RECT rc = new RECT();
        if (!CheckHResult(Toupcam_get_LevelRangeV2(_handle, out mode, out rc, aLow, aHigh)))
            return false;
        roiX = rc.left;
        roiY = rc.top;
    ...
    public bool put_Hue(int Hue)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Hue(_handle, Hue));
    }
    ...
    public bool get_Hue(out int Hue)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Hue(_handle, out Hue));
    }
    ...
    public bool put_Saturation(int Saturation)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Saturation(_handle, Saturation));
    }
    ...
    public bool get_Saturation(out int Saturation)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Saturation(_handle, out Saturation));
    }
    ...
    public bool put_Brightness(int Brightness)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Brightness(_handle, Brightness));
    }
    ...
    public bool get_Brightness(out int Brightness)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Brightness(_handle, out Brightness));
    }
    ...
    public bool get_Contrast(out int Contrast)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Contrast(_handle, out Contrast));
    }
    ...
    public bool put_Contrast(int Contrast)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Contrast(_handle, Contrast));
    }
    ...
    public bool get_Gamma(out int Gamma)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Gamma(_handle, out Gamma));
    }
    ...
    public bool put_Gamma(int Gamma)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Gamma(_handle, Gamma));
    }
    ...
    public bool get_Chrome(out bool bChrome)    /* monochromatic mode */
    {
        ...
        int iEnable = 0;
        if (!CheckHResult(Toupcam_get_Chrome(_handle, out iEnable)))
            return false;
    ...
    public bool put_Chrome(bool bChrome)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Chrome(_handle, bChrome ? 1 : 0));
    }
    ...
    public bool get_VFlip(out bool bVFlip) /* vertical flip */
    {
        ...
        int iVFlip = 0;
        if (!CheckHResult(Toupcam_get_VFlip(_handle, out iVFlip)))
            return false;
    ...
    public bool put_VFlip(bool bVFlip)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_VFlip(_handle, bVFlip ? 1 : 0));
    }
    ...
    public bool get_HFlip(out bool bHFlip)
    {
        ...
        int iHFlip = 0;
        if (!CheckHResult(Toupcam_get_HFlip(_handle, out iHFlip)))
            return false;
    ...
    public bool put_HFlip(bool bHFlip)  /* horizontal flip */
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_HFlip(_handle, bHFlip ? 1 : 0));
    }
    ...
    public bool get_Negative(out bool bNegative)
    {
        ...
        int iNegative = 0;
        if (!CheckHResult(Toupcam_get_Negative(_handle, out iNegative)))
            return false;
    ...
    public bool put_Negative(bool bNegative)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Negative(_handle, bNegative ? 1 : 0));
    }
    ...
    public bool put_Speed(ushort nSpeed)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Speed(_handle, nSpeed));
    }
    ...
    public bool get_Speed(out ushort pSpeed)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Speed(_handle, out pSpeed));
    }
    ...
    */
    public bool put_HZ(int nHZ)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_HZ(_handle, nHZ));
    }
    ...
    public bool get_HZ(out int nHZ)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_HZ(_handle, out nHZ));
    }
    ...
    public bool put_Mode(bool bSkip) /* skip or bin */
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Mode(_handle, bSkip ? 1 : 0));
    }
    ...
    public bool get_Mode(out bool bSkip)
    {
        ...
        int iSkip = 0;
        if (!CheckHResult(Toupcam_get_Mode(_handle, out iSkip)))
            return false;
    ...
    public bool put_TempTint(int nTemp, int nTint)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_TempTint(_handle, nTemp, nTint));
    }
    ...
    public bool get_TempTint(out int nTemp, out int nTint)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_TempTint(_handle, out nTemp, out nTint));
    }
    ...
    public bool put_WhiteBalanceGain(int[] aGain)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public bool get_WhiteBalanceGain(int[] aGain)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public bool put_AWBAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Toupcam_put_AWBAuxRect(_handle, ref rc));
    }
    ...
    public bool get_AWBAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Toupcam_get_AWBAuxRect(_handle, out rc)))
            return false;
    ...
    public bool put_AEAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Toupcam_put_AEAuxRect(_handle, ref rc));
    }
    ...
    public bool get_AEAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Toupcam_get_AEAuxRect(_handle, out rc)))
            return false;
    ...
    public bool put_BlackBalance(ushort[] aSub)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_BlackBalance(_handle, aSub));
    }
    ...
    public bool get_BlackBalance(ushort[] aSub)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_BlackBalance(_handle, aSub));
    }
    ...
    public bool put_ABBAuxRect(int X, int Y, int Width, int Height)
    {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        return CheckHResult(Toupcam_put_ABBAuxRect(_handle, ref rc));
    }
    ...
    public bool get_ABBAuxRect(out int X, out int Y, out int Width, out int Height)
    {
        ...
        RECT rc = new RECT();
        if (!CheckHResult(Toupcam_get_ABBAuxRect(_handle, out rc)))
            return false;
    ...
    public bool get_StillResolution(uint nResolutionIndex, out int pWidth, out int pHeight)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_StillResolution(_handle, nResolutionIndex, out pWidth, out pHeight));
    }
    ...
    public bool put_VignetEnable(bool bEnable)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_VignetEnable(_handle, bEnable ? 1 : 0));
    }
    ...
    public bool get_VignetEnable(out bool bEnable)
    {
        ...
        int iEanble = 0;
        if (!CheckHResult(Toupcam_get_VignetEnable(_handle, out iEanble)))
            return false;
    ...
    public bool put_VignetAmountInt(int nAmount)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_VignetAmountInt(_handle, nAmount));
    }
    ...
    public bool get_VignetAmountInt(out int nAmount)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_VignetAmountInt(_handle, out nAmount));
    }
    ...
    public bool put_VignetMidPointInt(int nMidPoint)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_VignetMidPointInt(_handle, nMidPoint));
    }
    ...
    public bool get_VignetMidPointInt(out int nMidPoint)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_VignetMidPointInt(_handle, out nMidPoint));
    }
    ...
    */
    public bool put_LEDState(ushort iLed, ushort iState, ushort iPeriod)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_LEDState(_handle, iLed, iState, iPeriod));
    }
    ...
    public bool put_Option(eOPTION iOption, int iValue)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Option(_handle, iOption, iValue));
    }
    ...
    public bool get_Option(eOPTION iOption, out int iValue)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Option(_handle, iOption, out iValue));
    }
    ...
    public bool put_Linear(byte[] v8, ushort[] v16)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Linear(_handle, v8, v16));
    }
    ...
    public bool put_Curve(byte[] v8, ushort[] v16)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Curve(_handle, v8, v16));
    }
    ...
    public bool put_ColorMatrix(double[] v)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_ColorMatrix(_handle, v));
    }
    ...
    public bool put_InitWBGain(ushort[] v)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_InitWBGain(_handle, v));
    }
    ...
    public bool get_Temperature(out short pTemperature)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Temperature(_handle, out pTemperature));
    }
    ...
    public bool put_Temperature(short nTemperature)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Temperature(_handle, nTemperature));
    }
    ...
    public bool put_Roi(uint xOffset, uint yOffset, uint xWidth, uint yHeight)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_put_Roi(_handle, xOffset, yOffset, xWidth, yHeight));
    }
    ...
    public bool get_Roi(out uint pxOffset, out uint pyOffset, out uint pxWidth, out uint pyHeight)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_Roi(_handle, out pxOffset, out pyOffset, out pxWidth, out pyHeight));
    }
    ...
    */
    public bool get_FrameRate(out uint nFrame, out uint nTime, out uint nTotalFrame)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_FrameRate(_handle, out nFrame, out nTime, out nTotalFrame));
    }
    ...
    public bool LevelRangeAuto()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_LevelRangeAuto(_handle));
    }
    ...
    public bool AwbOnce()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;        
        return CheckHResult(Toupcam_AwbOnce(_handle, IntPtr.Zero, IntPtr.Zero));
    }
    ...
    public bool AbbOnce()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_AbbOnce(_handle, IntPtr.Zero, IntPtr.Zero));
    }
    ...
    public bool FfcOnce()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_FfcOnce(_handle));
    }
    ...
    public bool DfcOnce()
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_DfcOnce(_handle));
    }
    ...
    public bool FfcExport(string filepath)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_FfcExport(_handle, filepath));
    }
    ...
    public bool FfcImport(string filepath)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_FfcImport(_handle, filepath));
    }
    ...
    public bool DfcExport(string filepath)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_DfcExport(_handle, filepath));
    }
    ...
    public bool DfcImport(string filepath)
    {
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_DfcImport(_handle, filepath));
    }
    ...
    public bool IoControl(uint ioLineNumber, eIoControType eType, int outVal, out int inVal)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_IoControl(_handle, ioLineNumber, eType, outVal, out inVal));
    }
    ...
    public bool get_AfParam(out AfParam pAfParam)
    {
        ...
        if (_handle == null || _handle.IsInvalid || _handle.IsClosed)
            return false;
        return CheckHResult(Toupcam_get_AfParam(_handle, out pAfParam));
    }
    ...
    public bool GetHistogram(DelegateHistogramCallback fnHistogramProc)
    {
        ...
        return CheckHResult(Toupcam_GetHistogram(_handle, _pHistogramCallback, _id));
    }
    ...
    */
    public static int Update(string camId, string filePath, DelegateProgress pdelegate)
    {
        ...
        int ret = Toupcam_Update(camId, filePath, pProgressCallback, id);
